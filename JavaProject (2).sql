...
--
-- Host: localhost:3306
-- Generation Time: Jun 14, 2024 at 01:08 AM
...
(7, 63, 7, 'none', 'Manchester', '13/06/2024 15:36:45', 1),
(8, 63, 8, 'none', 'xss', '14/06/2024 00:04:25', 1),
(9, 64, 9, 'iphone.jpeg', 'null', '14/06/2024 00:18:08', 1);
...
(5, 2, 'Ordered', '13/06/2024 15:16:45'),
(6, 2, 'Ordered', '13/06/2024 15:18:19'),
(7, 2, 'Ordered', '13/06/2024 15:36:45'),
(8, 2, 'Ordered', '14/06/2024 00:04:25'),
(9, 2, 'Ordered', '14/06/2024 00:18:08');
...
(7, 7, 7, 'mdc', '13/06/2024 15:36:45', '13/06/2024 15:36:45', 'cdh'),
(8, 8, 7, 'mdc', '14/06/2024 00:04:25', '14/06/2024 00:04:25', 'cdh'),
(9, 9, 8, 'mdc', '14/06/2024 00:18:08', '14/06/2024 00:18:08', 'cdh');
...
(63, 'iphone Cover', 2, 'Cutomize cover', 500, 'coveriphone.jpeg', 0, 1, 20, 5),
(64, 'mug', 1, 'mug with customize image', 600, 'cup.jpeg', 1, 0, 20, 3),
(65, 'sari', 1, 'cdc', 1, 'coveriphone.jpeg', 0, 1, 20, 1);
...
INSERT INTO `StagemasterTB` (`StageID`, `ProductID`, `Stagename`, `Stagedescription`, `Priority`) VALUES
(7, 63, 'Ordered', 'Product orderd', 0),
(8, 64, 'Ordered', 'Product orderd', 0),
(9, 65, 'Ordered', 'Product orderd', 0),
(10, 63, 'purchase cover', 'purchase blank cover according to phone', 1);
...
--
ALTER TABLE `OrderDetailsTB`
  MODIFY `OdetailsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `OrderTrackingTB`
  MODIFY `OrdertrackID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
